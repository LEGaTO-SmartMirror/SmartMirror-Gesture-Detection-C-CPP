...
int main(int argc, char *argv[]) {
    ...
    //static char *cfg_file = "../data/yolov4-tiny.cfg";
	//static char *cfg_file = "../data/yolov4.cfg";
	static char *cfg_file = "../data/yolov4-tiny-hand-3l.cfg";

    // Path to weight file.
    //static char *weight_file = "../data/yolov3.weights";
    //static char *weight_file = "../data/yolov4.weights";
	//static char *weight_file = "../data/yolov4-tiny.weights";
	static char *weight_file = "../data/yolov4-tiny-hand-3l_best.weights";
	...
	sprintf(cap_str, "shmsrc socket-path=/dev/shm/camera_image ! video/x-raw, format=BGR, width=%i, height=%i, framerate=30/1 ! videoconvert ! video/x-raw, format=BGR ! appsink drop=true",image_width,image_height);
